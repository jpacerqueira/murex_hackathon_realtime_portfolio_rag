...
try:
    from .llama_local_datamap_rag import LlamaLocalDatamapRAG
except ImportError:
    from datamap.llama_local_datamap_rag import LlamaLocalDatamapRAG
...
def create_streamlit_app():
    ...
    with st.expander("Advanced Settings"):
        col1, col2 = st.columns(2)
        with col1:
            region_name = st.text_input("Local Region Tag:", "local")
        with col2:
            ...
            try:
                ...
                with st.expander("Prism Mock Execution"):
                    ...
                    if not analysis_payload:
                        ...
                        steps = analysis_block.get("execution_steps") or analysis_payload.get("execution_steps") or []
                        api_calls = analysis_payload.get("api_calls") or []
